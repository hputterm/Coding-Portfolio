...
from prob2utils_bias import train_model, get_err
...
def main():
    ...
    U, V, A, B, e_in = train_model(M, N, 20, eta, .1, movies_total)
    ...
    titles = ["Most Popular Movies with Bias","Highest Rated Movies with Bias",
    "Movies we Chose with Bias", "Comedies with Bias", "Documentary with Bias", "Sci-Fi with Bias", "Star Wars and Star Trek With Bias"]
